...
player_stats_25_26 <- readRDS(url("https://github.com/zkautoupdates/autoupdates/raw/main/data/player_stats_25_26.rds"))
...
qot <- qot %>%
  ...
  left_join(player_stats_25_26 %>% select(playerID,teammate_OVR=OVR),by=c("player2"="playerID")) %>%
...
# Save data
f_lines %>% saveRDS("data/f_lines_25_26.rds")
